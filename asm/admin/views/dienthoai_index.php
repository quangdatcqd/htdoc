    ...
    <tbody>
      ...
      ?>
        ...
        <tr>
          ...
          <td><a onclick="return func()" href="<?= ADMIN_URL . '/?ctrl=dienthoai&act=delete&idDT=' . $listnsx['idDT'] ?>"><i class="bi bi-x-circle"></i></a></td>
        </tr>
...
<script>
  function func(){
    return confirm("Bạn có thực sự muốn xoá");
  }
