        ...
        function insert(){ 
            ...
            if(isset($_POST['nhap']) ){
                ...
                if(isset( $_POST['hot'])){
                 ...
                 $last_id = $this->model->insert($ten_dt,$mota,$link,$hot,$tonkho,$giakm,$idNSX,$gia,$thutu,$an, $ngay);   
                 $this->model->addthuoctinh($manhinh,$camerasau ,$cameratruoc,$cpu,$bonhotrong,$ram,$thenho,$sim,$pin,$hedieuhanh,$last_id);
