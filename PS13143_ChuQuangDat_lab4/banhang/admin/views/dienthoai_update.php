<div>
    <form action="<?= ADMIN_URL ?>/?ctrl=dienthoai&act=update" method="post" enctype="multipart/form-data">
        <input type="hidden" value="<?= $id_dt ?>" name="idDT">
        <div class="mb-3">
            <label for="ten_dt" class="form-label">Tên Điện Thoại</label>
            <input type="text" class="form-control" id="ten_dt" name="ten_dt" value="<?= $ten_dt ?>" placeholder="Nhập Tên Điện">
        </div>
        <div class="mb-3">
    ...
    <option value=""></option>
        ...
        <div class="form-group row">
            <div class="mb-3 col-sm-3">
                ...
                <input type="number" class="form-control" id="gia" name="gia" value="<?= $gia ?>" placeholder="Nhập Giá">
            </div>
            <div class="mb-3 col-sm-3">
                <label for="giakm" class="form-label">Giá KM</label>
                <input type="number" class="form-control" id="giakm" name="giakm" value="<?= $giakm ?>" placeholder="Nhập  Giá  ">
            </div>
            <div class="mb-3 col-sm-3">
                <label for="thutu" class="form-label">Thứ Tự</label>
                <input type="number" class="form-control" id="thutu" name="thutu" value="<?= $thutu ?>" placeholder="Nhập thứ tự">
            </div>
            <div class="mb-3 col-sm-3">
                <label for="tonkho" class="form-label">Tồn Kho</label>
                <input type="number" class="form-control" id="tonkho" name="tonkho" value="<?= $tonkho ?>" placeholder="Nhập Số Lượng Tồn Kho">
            </div>
        </div>
        <div class="form-group row">
            <div class="mb-3 col-sm-3">
                <label for="hide" class="form-label">Ẩn </label>
                <input type="checkbox" class="hide  " <?= $an_dt ?> id="hide" name="hide">
            </div>
            <div class="mb-3 col-sm-3">
                <label for="hot" class="form-label">HOT </label>
                <input type="checkbox" class="hot  " <?= $hot ?> id="hot" name="hot">
            </div>
            <div class="mb-3 col-sm-6">
